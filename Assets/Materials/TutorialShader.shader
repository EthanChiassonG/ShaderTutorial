Shader "Unlit/FirstShaderMultiUV_ViewDir"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // UV set keywords from the [KeywordEnum] above
            ...
            Varyings vert (Attributes IN)
            {
                ...
                OUT.positionWS  = posWS;                 // pass to fragment
                OUT.normalWS    = nrmWS;
            ...
            half4 frag (Varyings IN) : SV_Target
            {
                ...
                // -------- viewDir in URP --------
                // Vector from surface point to camera (world space)
                float3 viewDirWS = GetWorldSpaceViewDir(IN.positionWS);
                viewDirWS = SafeNormalize(viewDirWS);

                // Optional: Fresnel / rim using world-space normal
                ...
                color += (_RimColor.rgb * fres) * _RimStrength;       // additive/boost rim
